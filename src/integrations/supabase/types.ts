...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      expenses: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "expenses_outing_id_fkey"
            columns: ["outing_id"]
            isOneToOne: false
      ...
      outings: {
        ...
        Relationships: [
          {
            foreignKeyName: "outings_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      is_org_finance: { Args: { p_user_id: string }; Returns: boolean }
      is_org_manager: { Args: { p_user_id: string }; Returns: boolean }
      is_org_member: {
    ...
    Enums: {
      expense_status:
        ...
        | "rejected"
        | "reimbursed"
      org_role: "admin" | "finance" | "hr" | "manager" | "employee"
    }
    CompositeTypes: {
      [_ in never]: never
    }
